...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, L_SYMS,  KC_LGUI,      TG_MIC,      CL_SPC,  KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX
   //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
    ),
    [_SYMBOLS] = LAYOUT_planck_mit(
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      KC_TILD, KC_PERC, KC_HASH, KC_DLR,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CIRC, KC_ASTR, KC_MINS, KC_DEL,
      KC_BSLS, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT,   XXXXXXX, XXXXXXX, KC_GT,   KC_RPRN, KC_RBRC, KC_RCBR, KC_SLSH,
      KC_EXLM, KC_PIPE, KC_UNDS, KC_QUOT, KC_GRV,  XXXXXXX, XXXXXXX, XXXXXXX, KC_DQUO, KC_EQL,  KC_PLUS, KC_QUES,
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,     L_CTRL,       _______, OS_RALT, XXXXXXX, XXXXXXX, XXXXXXX
   //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
    ),
    [_COMMS] = LAYOUT_planck_mit(
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      KC_TAB,  KC_7,    KC_8,    KC_9,    XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_BSPC,
      KC_ESC,  KC_4,    KC_5,    KC_6,    XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,
      KC_LCTL, KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, XXXXXXX, KC_PSCR, KC_LSFT,
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, KC_0,    _______,     L_CTRL,       _______,  _______,  XXXXXXX, XXXXXXX, XXXXXXX
   //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
    ),
   ...
   //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,   _______,     L_CTRL,       _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
   //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
    ),
};
